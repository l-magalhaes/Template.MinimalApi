...
public interface IProductService
{
    ...
    Task<ProductDtos.Response?> GetByIdAsync(Guid id, CancellationToken ct = default);
    Task<ProductDtos.PagedResponse<ProductDtos.Response>> GetAllPagedAsync(ProductDtos.Query query, CancellationToken ct = default);
